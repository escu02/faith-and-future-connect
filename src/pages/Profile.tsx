          ...
          <div className="px-6 pb-6">
            <div className="relative flex flex-col md:flex-row md:justify-between">
              <div className="flex flex-col md:flex-row">
                <Avatar className="h-24 w-24 border-4 border-white -mt-12 md:-top-12 relative">
                  <div className="h-full w-full rounded-full bg-brand flex items-center justify-center">
                    <span className="text-white font-bold text-xl">JD</span>
                  </div>
                </Avatar>
                <div className="mt-4 md:mt-0 md:ml-4 md:pt-4">
                  <h2 className="text-2xl font-bold">John Doe</h2>
                  <p className="text-gray-600 text-sm md:text-base">Business Development Associate | St. Thomas Parish Youth Leader</p>
                </div>
              </div>
              <div className="absolute top-4 right-0 md:static">
                <Button 
                  variant="outline" 
                  size="icon" 
